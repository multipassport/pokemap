...
Теперь Вы имеете доступ к админке `http://127.0.0.1:8000/admin/`. В меню слева можно добавлять разновидноси покемонов, а также отдельные особи. Обязательные для создания поля будут выделены жирным шрифтом.
